...
/**
 * form for bulk user multi cohort remove
 *
 * @package    core
 * @subpackage user
...
class user_bulk_cohortremove_form extends moodleform {
    function definition() {
        $mform = $this->_form;
        ...
        $this->add_action_buttons(true, get_string('bulkremove', 'core_cohort'));
    }
}
